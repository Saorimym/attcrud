...
echo "<CENTER>Funcionários Registrados no Banco de Dados.<br></CENTER>";
echo "<br>";
...
echo "<tr><th>Código</th><th>Nome</th><th>Cargo</th><th>Salário</th><th>Endereço</th><th>Ações</th></tr>";
...
echo "</footer>";
    ...
    echo ("<br><br><a href='index_funcionarios.php'>Voltar</a>");}
?>